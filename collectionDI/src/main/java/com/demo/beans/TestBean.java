...
public class TestBean {
	...
	public void setSet1(List<String> set1) {
		this.set1 = set1;
	}

	public List<Integer> getSet2() {
		return set2;
	}

	public void setSet2(List<Integer> set2) {
		this.set2 = set2;
	}

	public List<DataBean> getSet3() {
		return set3;
	}

	public void setSet3(List<DataBean> set3) {
		this.set3 = set3;
	}
