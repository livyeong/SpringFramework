...
public class MainClass {
	public static void main(String[] args) {
		 ...
		 * 
		 * dao.insert_data(bean1); // 오라클 DB에 입력
		 * 
		 ...
		 * 
		 * for (JdbcBean bean : list) { System.out.printf("int_data:%d\n",
		 * bean.getInt_data()); System.out.printf("str_data:%s\n", bean.getStr_data());
		 * System.out.println("-------------------------------------");
		 * 
		 * 
		 * JdbcBean bean3 = new JdbcBean(); bean3.setInt_data(1);
